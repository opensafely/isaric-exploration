...
#
# Output: /output/data_properties/isaric_admission1*.txt
#
...
if(length(args)==0){
  ...
  csv_file <- "output/admissions/isaric_admission1.csv.gz"
...
stopifnot("must pass an .csv file" = fs::path_ext(csv_file)=="gz")
